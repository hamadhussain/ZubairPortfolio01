...
// /* ---------------- MOCKUP IMAGE COMPONENT ---------------- */
// const MockupEmbed = ({ index, folder }) => {
//   const [filePath, setFilePath] = useState(null);
//   const [loaded, setLoaded] = useState(false);

//   const exts = ["jpg", "png", "jpeg", "webp", "pdf"];
...
//   if (!filePath) return <div className="h-[200px] bg-gray-200">Loading...</div>;

//   const isPDF = filePath.endsWith(".pdf");

//   return (
//     <div className="relative bg-white shadow rounded overflow-hidden">
//       {!loaded && (
//         <div className="absolute inset-0 flex items-center justify-center bg-gray-100">
...
//         />
//       ) : (
//         <iframe src={filePath} className="w-full h-[300px]" onLoad={() => setLoaded(true)} />
//       )}
//     </div>
//   );
// };
...
//   return (
//     <div className="group bg-white shadow-lg rounded overflow-hidden relative min-h-[250px]">
//       {!loaded && (
...
//         href={url}
//         target="_blank"
//         className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition flex justify-center items-center"
//       >
//         <BsEye className="text-white text-5xl" />
//       </Link>
//     </div>
//   );
// };
...
//   return (
//     <div className="px-6 sm:px-10 md:px-24 py-16">

//       {/* ---------- TOP BUTTONS ---------- */}
//       <div className="flex gap-5 my-5">
//         <button
//           className={`button-89 ${activeFolder === "design" ? "bg-blue-500 text-white" : ""}`}
//           onClick={() => { setActiveFolder("design"); setActiveView("images"); }}
//         >
//           Design Mockup
//         </button>

//         <button
//           className={`button-89 ${activeFolder === "jpg" ? "bg-blue-500 text-white" : ""}`}
//           onClick={() => { setActiveFolder("jpg"); setActiveView("images"); }}
//         >
//           JPG Mockup
//         </button>

//         <button
//           className={`button-89 ${activeView === "figma" ? "bg-blue-500 text-white" : ""}`}
...
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
//           {imageIndexes.map((i) => (
//             <MockupEmbed key={i} index={i} folder={activeFolder} />
//           ))}
//         </div>
//       )}
...
//       {activeView === "figma" && (
//         <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
//           {figmaLinks.map((url, i) => (
//             <FigmaEmbed key={i} url={url} index={i} />
//           ))}
//         </div>
//       )}
...
export default function Portfolio() {
  ...
  const getFolderTitle = () => {
    if (activeFolder === "jpg") return "JPG Mockup";
    if (activeFolder === "design") return "Design Mockup";
    if (activeView === "figma") return "Figma Designs";
    return "";
  };
